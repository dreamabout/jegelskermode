...
var edit_mode = '1', // 再編輯模式 ( '1'=開; '0'=不開 )
		...
		pic_sb = wp_url + 'wp-content/themes/Selecta/images/loading.gif', // 提交 icon
		pic_no = wp_url + 'wp-content/themes/Selecta/images/error.png',      // 錯誤 icon
		pic_ys = wp_url + 'wp-content/themes/Selecta/images/yes.png',     // 成功 icon
