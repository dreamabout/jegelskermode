  ...
  ?>
        <div id="actions" class="site-actions clearfix">
            ...
            <div class="clearfix actions">
              ...
              <?php 
              $filledSocialLinks = array_filter($social_links, function($v) { return $v; });  
                if(count($filledSocialLinks) > 0 ) : ?>
                <div class="action socials">
                    <i class="icon-link active-socials"></i>
                    <ul class="unstyled list-socials clearfix" style="width: <?php echo count($filledSocialLinks)*40; ?>px;">
