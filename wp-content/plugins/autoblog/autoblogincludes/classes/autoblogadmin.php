...
class autoblogpremium {
	...
	function dashboard_stats() {
		...
		<div class="postbox ">
			...
			<div class="inside">
				...
				?>
				<p><strong>We're not showing any feed stats as it's consuming a lot of the page</strong></p>
			</div>
		</div>
		<?php
	}
	...
	function show_table($key, $details) {
		...
		do_action( 'autoblog_feed_edit_form_author_details_start', $key, $details );
		...
		echo "</td>";
		echo "</tr>\n";
		do_action( 'autoblog_feed_edit_form_author_details_end', $key, $details );
